...
internal suspend fun runFilesToolLoop(
    ...
    val systemPrompt = """
        ...
        1. Когда нужно создать или изменить файл — сначала сформируй ПОЛНОЕ содержимое файла в своих мыслях.
        2. Вызови write_file с параметром content = ПОЛНЫЙ текст файла (не пустой, не placeholder).
        3. Никогда не передавай пустой content в write_file — это создаст пустой файл.
        4. Если нужно показать diff без записи — используй generate_diff(path, new_content).
